...
description: Interpolation, Bézier curves, B-splines, NURBS, and spline surfaces.
order: 5
kind: topic
downloadPath: /content/computer-graphics/curves-and-surfaces.md
...
- $p_0$ has maximum influence at $t=0$.
- $p_1$ has maximum influence around $t=\frac{1}{2}$.
- $p_2$ has maximum influence at $t=1$.
...
- $N$ control points produce degree $N-1$.
...
::cg-example{variant="bezier-surface"}
::
...
- One control point influences roughly $t=i-2$ to $t=i+2$.
