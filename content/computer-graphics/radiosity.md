---
title: Radiosity
description: Diffuse global illumination through patch-to-patch energy transfer.
order: 2
kind: topic
downloadPath: /content/computer-graphics/radiosity.md
...
::cg-example{variant="radiosity-patches"}
::
...
::cg-example{variant="form-factors"}
::
...
::cg-example{variant="radiosity-gathering"}
::
...
::cg-example{variant="radiosity-shooting"}
::
