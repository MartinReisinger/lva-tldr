...
description: Scalar, vector, and tensor visualization for sampled scientific datasets.
order: 4
kind: topic
downloadPath: /content/computer-graphics/scientific-data-visualization.md
...
::cg-example{variant="scalar-contours"}
::
...
::cg-example{variant="vector-field"}
::
...
::cg-example{variant="stream-tube"}
::
...
::cg-example{variant="tensor-field"}
::
