...
description: Visualizing sampled 3D data with transfer functions, ray casting, splatting, and isosurfaces.
order: 3
kind: topic
downloadPath: /content/computer-graphics/volume-rendering.md
...
::cg-example{variant="transfer-function"}
::
...
::cg-example{variant="marching-cubes"}
::
